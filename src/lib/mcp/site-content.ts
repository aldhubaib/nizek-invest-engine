...
export async function buildHomePage() {
  ...
  const sections: Section[] = [
    ...
    },
    {
      ...
      subheadline:
        "We are not allocating capital into an idea. We are applying seventeen years of building technology companies in the GCC to a repeatable venture engine.",
      body: ["Fifty companies is not an ambition. It is capacity we already operate."],
      metrics: [
        { label: "Building technology companies since", value: "2009" },
        { label: "Years operating in GCC markets", value: "17+" },
        { label: "Digital products shipped", value: "120+" },
        { label: "Regional breakout — Dabdoob", value: "1" },
      ],
      cards: [
        {
          title: "Dabdoob",
          index: "Proof point",
          body: "Built with Nizek and scaled into one of the region's most recognised consumer platforms — institutionally funded and operating across the GCC.",
        },
        {
          title: "Current portfolio",
          body: "Companies currently being built inside the studio.",
          note: "Ad Space (Active), Hazawy (Active)",
        },
        {
          title: "What we provide",
          body: "Nizek contributes experience, execution and venture-building infrastructure—not outsourced services. Our objective is to build companies that become independent and continue growing long after they leave the studio.",
          note: "Venture-building operating partner, not an agency.",
        },
      ],
      lists: [
        { label: "Current portfolio", items: ["Ad Space", "Hazawy"] },
        {
    ...
    },
    {
      ...
      body: [
        ...
        "Built To Become Independent. At the end of the first year, the startup begins building its own internal technology team. NIZEK supports the transition through documentation, knowledge transfer and technical handover.",
      ...
      timeline: [
        ...
        { step: "05", title: "Knowledge Transfer", note: "Documentation and handover" },
