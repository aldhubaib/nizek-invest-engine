...
export async function buildHomePage() {
  ...
  const sections: Section[] = [
    ...
    },
    {
      ...
      section_id: "regional",
      section_order: 13,
      eyebrow: "12 — Regional founder pipeline",
      headline: "The Best Companies Start With The Best Founders.",
      subheadline:
        "Nizek is not limited to sourcing entrepreneurs from one city or one country. We actively identify founders and opportunities across the GCC, increasing the quality of ideas, the diversity of the portfolio and the probability of building exceptional companies.",
      body: [
        "The investment thesis: the larger the founder pipeline, the better the entrepreneurs, the better the ideas, the better the companies, the stronger the portfolio.",
        "Regional sourcing improves portfolio quality before any capital is invested.",
        "The venture studio begins with sourcing exceptional founders — not with funding random ideas.",
        "Why this matters: expanding the sourcing network across the GCC gives investors exposure to a far broader and more diversified pipeline of founders than a venture studio limited to a single local market. The emphasis is on increasing the quality of founder selection and reducing portfolio concentration risk.",
        "Investment philosophy: “We believe the hardest asset to find is not capital. It is exceptional entrepreneurs. Everything else can be built around them.”",
        "Our competitive advantage is not access to more capital. It is access to more founders.",
      ],
      cards: [
        {
          index: "01",
          title: "Better Founder Selection",
          body: "A regional pipeline allows us to evaluate more entrepreneurs and select only the strongest founders.",
        },
        {
          index: "02",
          title: "Higher Quality Opportunities",
          body: "Looking across multiple ecosystems increases the likelihood of identifying exceptional business ideas before they become obvious.",
        },
        {
          index: "03",
          title: "Portfolio Diversification",
          body: "Building companies across different GCC markets and industries reduces concentration risk and creates a healthier portfolio.",
        },
        {
          index: "04",
          title: "Larger Opportunity Pool",
          body: "Instead of relying on a single local ecosystem, Nizek continuously sources founders and ideas from across the region.",
        },
      ],
      timeline: [
        { step: "01", title: "GCC Entrepreneurs" },
        { step: "02", title: "Founder Evaluation" },
        { step: "03", title: "Residency Program" },
        { step: "04", title: "Venture Studio" },
        { step: "05", title: "Portfolio Companies" },
      ],
      diagram: {
        label: "Founder sourcing network — animated SVG map of the GCC",
        nodes: [
          { label: "Kuwait" },
          { label: "Saudi Arabia" },
          { label: "Bahrain" },
      ...
      ui: ui({ layout: "thesis strip + map diagram + card grid + flow", columns: 4, hasImage: true }),
