...
export async function buildHomePage() {
  ...
  const sections: Section[] = [
    ...
    },
    {
      ...
      headline: "Own Part of the Portfolio. Not Individual Startups.",
      subheadline:
        "Investors participate in Nizek's venture portfolio by acquiring a percentage of Nizek's equity allocation. Startup ownership is not diluted by incoming investors.",
      body: [
        "The ownership flow: Founder → Startup → Nizek earns equity by building the company → Investor participates in Nizek's equity allocation → Investor owns a share of the portfolio.",
        "Nizek does not purchase startup equity. Nizek earns equity by contributing venture-building capability, and that contribution replaces the traditional cash investment made by many venture investors.",
        "The investor's ownership is created from Nizek's equity allocation. The founder's ownership structure remains unchanged.",
        "Founder alignment: Nizek negotiates anti-dilution protection individually with every startup. Each agreement is negotiated independently, so terms are not identical across the portfolio. The minimum protection threshold is based on a KD3,000,000 valuation, and the purpose is to protect long-term portfolio ownership while keeping founders aligned.",
        "Why founders give equity to Nizek: founders receive far more than software development. They receive an experienced venture-building partner that helps validate the opportunity, build the product, launch the company, recruit the team and provide long-term CTO leadership. The equity reflects years of execution, infrastructure and operating support — not simply development work.",
        "Our investors participate in the value Nizek creates. Not in additional dilution imposed on founders.",
      ],
      metrics: [
        { label: "Founder (example startup)", value: "70%" },
        { label: "Nizek (example startup)", value: "30%" },
        { label: "Investor participation in Nizek's allocation (1 seat)", value: "5%" },
        { label: "Effective share of the startup (1 seat)", value: "1.5%" },
        { label: "Minimum protection threshold", value: "KD3,000,000" },
      ],
      lists: [
        {
          label: "How Nizek earns equity",
          items: [
            "Product Strategy",
        ...
        {
          label: "Key investor benefits",
          items: [
            "No Startup Dilution — investor ownership comes from Nizek's allocation.",
            "Founder Alignment — founders remain highly incentivized.",
            "Long-Term Protection — portfolio ownership is protected through negotiated anti-dilution provisions.",
            "Transparent Structure — every investor understands exactly where ownership originates.",
          ],
        },
      ],
      diagram: {
        ...
        nodes: [
          { label: "Founder", value: "70%", note: "Remains the majority owner." },
          { label: "Startup", value: "", note: "The company is created and launched." },
          {
            label: "Nizek earns equity by building the company",
            value: "30%",
            note: "Equity is earned through work, not purchased with cash.",
          },
          {
            label: "Investor participates in Nizek's equity allocation",
            value: "5% per seat",
            note: "Carved out of Nizek's allocation, never from the founder's ownership.",
          },
          {
            label: "Investor owns a share of the portfolio",
            value: "",
            note: "Exposure across every company Nizek builds.",
          },
        ],
      },
      ui: ui({ layout: "flow strip + contribution grid + example table + benefit cards", columns: 4, theme: "dark" }),
