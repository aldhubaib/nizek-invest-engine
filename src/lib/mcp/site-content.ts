  ...
  const sections: Section[] = [
    ...
    },
    {
      ...
      metrics: [
        ...
        { label: "02 — MOIC", value: `${result.moic.toFixed(2)}x`, note: "Derived from the assumptions selected above." },
        {
    ...
    },
    {
      ...
      section_id: "reserve",
      section_order: 22,
      eyebrow: "12 — Request allocation",
      headline: "Request Your Ownership Position.",
      subheadline:
        "Select the available Investor positions you would like to discuss with Nizek. Your request will be sent directly to the Nizek investment team.",
      body: [
        `Each position represents ${m.SEAT_OWNERSHIP}% ownership in Nizek Venture Studio Fund A, at ${kd(m.SEAT_QUARTERLY_COMMITMENT)} every three months, paid quarterly in advance.`,
        "Submitting a request does not create a binding investment commitment.",
        "Important: Requests are reviewed in the order they are received.",
        ...
        "Success state — Request Received: Our investment team will review your requested ownership positions and contact you directly.",
      ],
      metrics: [
        { label: "Selected", value: "Investor A–F (only available positions)" },
      ...
      lists: [
        {
          ...
          items: [
            ...
            "Selected ownership positions (auto-filled)",
            "Message (optional)",
          ],
        },
      ],
      cta: [{ label: "Submit investment request" }, { label: "Sending…" }],
