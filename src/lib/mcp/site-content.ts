      ...
      lists: [
        { label: "Current portfolio", items: ["Ad Space", "Hazawy"] },
        {
          ...
          items: [
            ...
            "Dedicated Team Transition — The startup moves from Nizek's shared venture-building resources to its own dedicated internal engineering team, while Nizek continues as long-term CTO and technical leadership partner.",
          ],
        },
      ],
