  ...
  head: () => ({
    meta: [
      ...
      { title: "NIZEK — Interactive Investor Platform" },
      {
        name: "description",
        content:
          "An interactive investment platform: live financial model, scenario simulator and investor return engine.",
      },
      { name: "author", content: "NIZEK" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Instrument+Sans:ital,wght@0,400;0,500;0,600;1,400&family=JetBrains+Mono:wght@300;400;500&display=swap",
      },
